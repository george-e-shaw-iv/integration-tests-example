...
const (
	...
	insert = "INSERT INTO item (list_id, name, quantity, created, modified) VALUES ($1, $2, $3, $4, $5);"
	...
	// delete is a query that deletes a row in the item table
	delete = "DELETE FROM item WHERE item_id = $1"
)
